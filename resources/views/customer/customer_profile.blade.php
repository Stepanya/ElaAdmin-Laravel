...
@section('content')
    <div class="row">
        ...
        <div class="col-5">
            <div class="card text-center">
                <div class="card-header">
                    <strong class="card-title">Submitted Picture(s)</strong>
                </div>
                <div class="card-body">
                    <div class="table-responsive" style="max-height: 200px">
                        <table class="table table-sm table-hover table-bordered">
                            <tr>
																<td><a href="images/image-provided.jpg" target="_blank">image-provided.jpg</a></td>
														</tr>
														<tr>
																<td><a href="images/image-provided-2.jfif" target="_blank">image-provided-2.jfif</a></td>
														</tr>
                        </table>
                    </div>
                    <select class="form-control mt-3">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-1">
                    <input type="text" class="form-control bg-success text-light text-center mt-4" readonly value="100"
                        style="height: 310%">
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-4">
                    ...
                    <textarea class="form-control" readonly value="19990522"
                        style="resize: none;">1048 St. Centennial Farm Road, Pinagbuhatan, Pasig City, 1602</textarea>
                </div>
                <div class="form-group col-4">
                    <label>Present Address</label>
                    <textarea class="form-control" readonly value="1999/05/22"
                        style="resize: none;">1048 St. Centennial Farm Road, Pinagbuhatan, Pasig City, 1602</textarea>
                </div>
                <div class="form-group col-1 mt-4">
                    <input type="text" class="form-control bg-success text-light text-center" readonly value="100"
                    ...
                    <button class="btn btn-success btn-block">Update</button>
						...
						<div class="form-row">
							<div class="table-responsive overflow-auto">
								<caption><h3>Audit Trail History</h3></caption>
